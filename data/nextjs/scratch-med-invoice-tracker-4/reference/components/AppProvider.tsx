...
const SEED: Invoice[] = [
  { id: 1, client: 'Acme Corp', amount: 500.00, paid: false },
  { id: 2, client: 'Globex', amount: 250.00, paid: true },
  { id: 3, client: 'Initech', amount: 125.50, paid: false },
]
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  function markPaid(id: number) {
    setInvoices((prev) =>
      prev.map((inv) => (inv.id === id ? { ...inv, paid: true } : inv))
    )
  }
