...
import type { Category, StatusType } from '../lib/types'

const CATEGORIES: Category[] = ['Web', 'Mobile', 'Design', 'Other']

export function Projects() {
  const { projects, addProject, toggleStatus, deleteProject, defaultStatus } = useApp()
  ...
  return (
    <section aria-label="Projects view">
      <h1>{`Projects (${displayed.length})`}</h1>
      <div>
        <input
