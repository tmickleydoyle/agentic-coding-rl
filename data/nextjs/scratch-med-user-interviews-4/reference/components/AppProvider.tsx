...
const SEED: Interview[] = [
  { id: 1, participant: 'Alice', segment: 'Enterprise', takeaway: 'Needs SSO integration' },
  { id: 2, participant: 'Bob', segment: 'SMB', takeaway: 'Wants better onboarding' },
  { id: 3, participant: 'Carol', segment: 'Enterprise', takeaway: 'Concerned about pricing' },
]
