...
const SEED: Lead[] = [
  { id: 1, company: 'Acme Corp', stage: 'new', dealValue: 1000 },
  { id: 2, company: 'Globex', stage: 'demo', dealValue: 2500 },
  { id: 3, company: 'Initech', stage: 'won', dealValue: 800 },
]
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  function addLead(company: string, stage: Stage, dealValue: number) {
    ...
    if (!c || dealValue <= 0) return
    setLeads((l) => [...l, { id: nextId, company: c, stage, dealValue }])
    setNextId((n) => n + 1)
  }
